# Batch 19 page generator - remaining neighborhoods
$CSS = @'
...
# Neighborhood data: slug, display, region, era-description, unique-para (for dishwasher), issues, washer-unique, fridge-unique
$neighborhoods = @(
  @{
    slug="rideau-park"; display="Rideau Park"; region="SW"; eyebrow="Calgary SW · Rideau Park"
    era="1950s affluent mature"
  ...
  @{
    ...
    era="1950s small mature family"
    dw_para="Meadowlark Park is a compact, quiet residential pocket in SW Calgary near Glenmore Reservoir, developed in the 1950s with approximately 610 homes. Its small size and low population density mean the neighbourhood receives relatively few appliance service calls compared to larger nearby communities, but the 60–70 year age of homes means original kitchen configurations have largely been modernized through renovation. Dishwasher repair in Meadowlark Park typically involves mid-range Whirlpool, Maytag, or Frigidaire units from the 1990s–2000s that have been in continuous service, as well as Bosch and KitchenAid units in more recently renovated kitchens. Calgary's 150–200 ppm water hardness creates calcium buildup issues on all machines, particularly on older units where the water softening reservoir has never been serviced. Our dispatch from 700 6th Ave SW reaches Meadowlark Park in approximately 20 minutes via Glenmore Trail."
  ...
  @{
    ...
    ws_para="Washer repair in Shawnee Slopes involves a mix of late-model top-loaders and front-loaders. Maytag and Whirlpool high-efficiency top-loaders from 2005–2015 are common, along with Samsung and LG front-loaders in renovated laundry rooms. Lid actuator failures, bearing noise, and control board errors are the most frequent call types. Fish Creek proximity means no access delays — we dispatch directly from Macleod Trail."
    ...
    fr_para="Fridge repair in Shawnee Slopes typically involves Samsung and LG French-door models from the 2010s, alongside KitchenAid French-door and Whirlpool side-by-side units in older kitchens. Ice maker water valve failures and ice maker assembly replacement are the leading repair types. We carry OEM ice maker assemblies for all major brands and typically complete repairs on the first visit."
    fr_issues=@("Samsung and LG French-door ice maker water valve and assembly failures","KitchenAid French-door ice dispenser door actuator replacement","Whirlpool side-by-side compressor and condenser fan diagnostics","Fish Creek area temperature swings affecting outdoor-adjacent condenser performance")
  ...
  @{
    ...
    era="industrial mixed-use, small residential"
    dw_para="Manchester is a small SE Calgary community with mixed industrial and residential zoning, located south of the Stampede Grounds near the Macleod Trail corridor. With a residential population of approximately 950, Manchester is not a traditional family suburb — its housing stock consists primarily of small infill condominiums, townhouses, and a limited number of older single-family homes. Dishwasher repair in Manchester is predominantly condo and townhouse work: Whirlpool, Frigidaire, and Bosch dishwashers installed in compact kitchen configurations. The community's location adjacent to Calgary's transit corridors means no delays reaching the neighbourhood — our technicians from 700 6th Ave SW are typically on-site within 15–20 minutes. Calgary's 150–200 ppm hard water affects compact dishwashers disproportionately because smaller water reservoirs cycle harder minerals through precision spray systems more quickly, accelerating nozzle blockages and spray arm wear."
    dw_issues=@("Compact condo-format Whirlpool and Frigidaire drain pump and float failures","Bosch spray arm blockage from concentrated hard water cycling in compact units","Townhouse integrated dishwasher door latch and seal failures","Control board error codes in compact Frigidaire Gallery and Whirlpool Gold units")
  ...
  @{
    ...
    era="small upscale family enclave"
    dw_para="Diamond Cove is a small, upscale SE Calgary community of approximately 625 homes tucked along the Bow River south of Fish Creek Provincial Park, developed in the 1980s as an exclusive residential pocket within the Lake Bonavista area. Its river and park adjacency, estate-sized lots, and executive housing stock make it comparable to SW Calgary's premium communities in terms of appliance sophistication. Dishwasher repair in Diamond Cove commonly involves KitchenAid, Bosch, and Miele units — brands standard in executive kitchens from the 1980s–2000s and in more recent renovations. The neighbourhood's 30–35 year old homes mean original appliances have typically been replaced at least once, but second-generation machines purchased in the 2000s are now entering their peak repair window. Calgary's 150–200 ppm hard water has accumulated significant calcium scale in these machines over two decades, particularly on heating elements and wash pump impellers. Our technicians reach Diamond Cove from 700 6th Ave SW in approximately 30–35 minutes via Macleod Trail and Bow Bottom Trail."
    dw_issues=@("KitchenAid and Bosch 2000s-era circulation pump and heating element scale from 150–200 ppm water","Miele precision wash system descaling and sensor recalibration","Executive kitchen integrated panel dishwasher door alignment","Older Fisher & Paykel DishDrawer rail and valve failures in river-view estate kitchens")
    ws_para="Washer repair in Diamond Cove involves premium front-load brands in executive laundry rooms. Miele W1, Electrolux, and LG ultra-large capacity front-loaders are common. Drum bearing failures, door boot seal deterioration, and drain pump blockages are the leading issues. River-adjacent humidity can accelerate door seal mould growth in front-load machines, which we treat as part of comprehensive service."
    ws_issues=@("Miele W1 and Electrolux front-load drum bearing and seal replacement","LG ultra-large front-load drain pump and tub bearing diagnostics","Door boot seal mould treatment and replacement in river-adjacent humid conditions","Hard water scale on premium front-load wash drum inner seals")
    fr_para="Refrigerator repair in Diamond Cove means executive-kitchen premium brands — Sub-Zero columns, KitchenAid French-door, and LG Studio counter-depth units. Sealed system diagnostics for Sub-Zero, ice maker assembly failures in KitchenAid, and water dispenser valve blockages in LG are the most common call types. We carry OEM parts for all executive brands."
  ...
  @{
    ...
    era="1973 small family neighbourhood"
    dw_para="Bonavista Downs is a small, established SE Calgary community of approximately 830 homes developed in 1973 adjacent to the original Lake Bonavista community. Its bungalow-dominant streetscape and mature tree canopy give it the feel of an older inner suburb, though it sits firmly in Calgary's SE quadrant. Dishwasher repair in Bonavista Downs most commonly involves 1990s–2000s Whirlpool, Maytag, and Frigidaire machines that have been in continuous service for 20+ years, alongside newer Samsung and Bosch units in renovated kitchens. The 1973-era homes feature compact original kitchen layouts that sometimes require minor modification to access dishwasher drain lines and water connections. Calgary's 150–200 ppm hard water has had a compounding effect over the 20–25 year service life of older machines here — spray arm blockage, control board corrosion from mineral-laden steam, and heating element scale are all common findings on first inspection. Our dispatch reaches Bonavista Downs from 700 6th Ave SW in approximately 30 minutes via Macleod Trail and Anderson Road."
    ...
    ws_para="Washer repair in Bonavista Downs is dominated by top-load Whirlpool and Maytag machines from the 1990s–2000s. Lid switch failures, drive motor worn brushes, and pump blockages are the most common issues. Some homeowners have upgraded to LG or Samsung front-loaders, which develop drum bearing noise and door seal failures in the 8–12 year range. We carry parts for both generations on Bonavista Downs service runs."
    ...
    fr_para="Fridge repair in Bonavista Downs covers a wide age range — from original 1990s Frigidaire and Whirlpool top-freezers to newer LG and Samsung French-door models. Defrost system failures, compressor relay issues, and ice maker assembly replacements are the most common service requests. We stock OEM parts for all prevalent brands in this neighbourhood."
  ...
  @{
    ...
    fr_para="Fridge repair in Albert Park/Radisson Heights spans from 1990s Frigidaire and GE top-freezer models still in service to newer LG and Samsung French-door units in renovated homes. Defrost thermostat failures, compressor relay issues, and ice maker water valve blockages are the most common repair types. We carry OEM parts for all major brands relevant to this neighbourhood."
  ...
  @{
    ...
    era="small mature family area"
    dw_para="Red Carpet is a small SE Calgary residential community of approximately 1,745 homes located near Forest Lawn and 17th Avenue SE, developed primarily in the 1960s–1970s as an affordable family neighbourhood. Its modest bungalow and row-house stock represents the working-class east side of Calgary's post-war residential expansion. Dishwasher repair in Red Carpet tends to involve mid-range and entry-level machines — Whirlpool, Frigidaire, GE, and Maytag dishwashers from the 1990s–2000s that have been running continuously for 20+ years. These machines present predictable failure patterns: drain pump wear, water inlet valve blockages, control board failures, and door latch deterioration. Calgary's 150–200 ppm hard water accelerates component wear in these mid-range machines faster than in premium brands with better filtration systems. Many Red Carpet homeowners face the repair-vs-replace decision given the age of their machines; our flat $65 diagnostic provides honest guidance on whether repair is economical. Our technicians dispatch from 700 6th Ave SW and reach Red Carpet in approximately 25–30 minutes via Memorial Drive or 17th Avenue SE."
  ...
  @{
    ...
    era="mature family neighbourhood"
    dw_para="Southview is a small, established SE Calgary community of approximately 1,550 residents located along 17th Avenue SE near Inglewood, developed primarily in the mid-20th century as a transitional neighbourhood between Calgary's inner-city and eastern suburbs. Its mix of bungalows and semi-detached homes reflects modest post-war residential construction, with ongoing infill development adding newer semi-detached units on corner lots. Dishwasher repair in Southview typically involves older Whirlpool, Maytag, and GE machines in original kitchen configurations, alongside newer Bosch and Samsung units in recently renovated homes. Calgary's 150–200 ppm Bow River water has accumulated significant calcium scale in long-running dishwashers here — particularly in machines where the filter basket has never been cleaned, causing pump cavitation and reduced wash performance. Being adjacent to Inglewood, Southview benefits from the same rapid dispatch coverage: our technicians from 700 6th Ave SW are on-site in approximately 20–25 minutes via 17th Avenue SE or Memorial Drive."
    dw_issues=@("Whirlpool and Maytag filter basket clogging from uncleaned calcium deposits in 150–200 ppm water","GE dishwasher pump cavitation and wash performance decline from scale","Bosch mid-range spray arm and control board service in renovated homes","Samsung control board error codes and door latch diagnostics")
    ws_para="Washer repair in Southview involves a mix of older top-load and newer front-load machines. Long-running Whirlpool top-loaders with drum agitator and pump issues are the most common call type, along with newer Samsung front-loaders with door seal and bearing failures. We dispatch quickly to Southview given its proximity to the Inglewood service corridor."
...
function Build-Page {
  param($slug, $display, $region, $eyebrow, $serviceSlug, $serviceName, $serviceShort, $region2, $para, $issues, $nearby, $id_suffix, $dw_angle)

  $title = "$serviceName $display Calgary | Neary Appliance"
  $desc_base = "$serviceName in $display, Calgary $region2 — same-day, flat `$65 diagnostic, 90-day warranty."
  $canonical = "https://appliancerepairneary.com/$serviceSlug-$slug"
  $h1 = "$serviceName in $display, Calgary"
  $answer_text = "Same-day $serviceShort repair in $display, Calgary. We fix all major brands — Samsung, LG, Whirlpool, Bosch, Kenmore, KitchenAid, Miele, GE &amp; more. Flat `$65 diagnostic, waived when repair proceeds. 90-day warranty."

  $issues_html = ($issues | ForEach-Object { "<li><strong>$_</strong></li>" }) -join "`n      "

  $nearby_html = ($nearby | ForEach-Object {
    $parts = $_ -split '\|'
    "<a href=`"/$($parts[0])`" class=`"related-link`">$($parts[1])</a>"
  }) -join "`n      "

  $faq_q1 = "Do you offer same-day $serviceShort repair in $display?"
  $faq_a1 = "Yes — we offer same-day $serviceShort repair throughout $display, Calgary. Book before noon on weekdays for same-day service. We dispatch from 700 6th Ave SW, Calgary."
  $faq_q2 = "What does $serviceShort repair cost in $display?"
  $faq_a2 = "Most repairs run `$120–`$380 CAD parts and labour. The flat `$65 diagnostic fee is waived when you proceed with the repair. You receive a written quote before any work begins."
  $faq_q3 = "Which brands do you repair in $display?"
  $faq_a3 = "We repair Samsung, LG, Whirlpool, Bosch, GE, Frigidaire, Maytag, Electrolux, KitchenAid, Kenmore, Miele, and most other brands found in $display homes."

  $dw_hard_water = ""
  if ($serviceSlug -eq "dishwasher") {
    $dw_hard_water = @"
...
"@
  ...
  $service_type = switch ($serviceSlug) {
...
<title>$title</title>
<meta name="description" content="$desc_base Book online or email calgary@appliancerepairneary.com.">
...
<main class="page-main container" id="main-content">
  ...
  <section class="booking-section fade-in">
    ...
    <iframe id="fixlify-$id_suffix" src="https://hub.fixlify.app/book/nicks-appliance-repair-b8c8ce?embed=true" style="width:100%;height:600px;border:none;display:block" title="Book $serviceName in $display" loading="lazy" allowtransparency="true"></iframe>
    <script>window.addEventListener('message',function(e){if(e.data&&e.data.type==='fixlify-resize'){var el=document.getElementById('fixlify-$id_suffix');if(el)el.style.height=e.data.height+'px'}});</script>
  ...
  <section class="faq-section fade-in">
    <div class="container" style="padding:0">
      ...
      <div class="faq-list">
        <details class="faq-item"><summary class="faq-question"><span class="faq-q-text">$faq_q1</span><span class="faq-icon">+</span></summary><div class="faq-answer"><p>$faq_a1</p></div></details>
        <details class="faq-item"><summary class="faq-question"><span class="faq-q-text">$faq_q2</span><span class="faq-icon">+</span></summary><div class="faq-answer"><p>$faq_a2</p></div></details>
        <details class="faq-item"><summary class="faq-question"><span class="faq-q-text">$faq_q3</span><span class="faq-icon">+</span></summary><div class="faq-answer"><p>$faq_a3</p></div></details>$dw_hard_water
      </div>
    </div>
  </section>
</main>
...
<footer class="site-footer" data-footer-region="calgary"><div class="container">
  ...
  <p>&copy; <span id="fy-$id_suffix"></span> Appliance Repair Near You &mdash; Calgary</p>
</div></footer>
<script>(function(){var el=document.getElementById('fy-$id_suffix');if(el)el.textContent=new Date().getFullYear()})();</script>
...
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"$faq_q1","acceptedAnswer":{"@type":"Answer","text":"$faq_a1"}},{"@type":"Question","name":"$faq_q2","acceptedAnswer":{"@type":"Answer","text":"$faq_a2"}},{"@type":"Question","name":"$faq_q3","acceptedAnswer":{"@type":"Answer","text":"$faq_a3"}}]}
</script>
</body>
</html>
"@
...
foreach ($n in $neighborhoods) {
  # Dishwasher page
  $dw_nearby = $n.nearby_dw + @("washer-repair-$($n.slug)|Washer Repair — $($n.display)", "fridge-repair-$($n.slug)|Fridge Repair — $($n.display)")
  $content = Build-Page -slug $n.slug -display $n.display -region $n.region -eyebrow $n.eyebrow `
    -serviceSlug "dishwasher" -serviceName "Dishwasher Repair" -serviceShort "dishwasher" `
    -region2 $n.region -para $n.dw_para -issues $n.dw_issues -nearby $dw_nearby `
    -id_suffix "$($n.slug -replace '-','_')-dw" -dw_angle "yes"
  Set-Content -Path "$dir/dishwasher-repair-$($n.slug).html" -Value $content -Encoding UTF8
  Write-Output "Created: dishwasher-repair-$($n.slug).html"
  $count++

  # Washer page
  $ws_nearby = $n.nearby_ws + @("dishwasher-repair-$($n.slug)|Dishwasher Repair — $($n.display)", "fridge-repair-$($n.slug)|Fridge Repair — $($n.display)")
  $content = Build-Page -slug $n.slug -display $n.display -region $n.region -eyebrow $n.eyebrow `
    -serviceSlug "washer" -serviceName "Washer Repair" -serviceShort "washer" `
    -region2 $n.region -para $n.ws_para -issues $n.ws_issues -nearby $ws_nearby `
    -id_suffix "$($n.slug -replace '-','_')-ws" -dw_angle "no"
  Set-Content -Path "$dir/washer-repair-$($n.slug).html" -Value $content -Encoding UTF8
  Write-Output "Created: washer-repair-$($n.slug).html"
  $count++

  # Fridge page
  $fr_nearby = $n.nearby_fr + @("dishwasher-repair-$($n.slug)|Dishwasher Repair — $($n.display)", "washer-repair-$($n.slug)|Washer Repair — $($n.display)")
  $content = Build-Page -slug $n.slug -display $n.display -region $n.region -eyebrow $n.eyebrow `
    -serviceSlug "fridge" -serviceName "Fridge Repair" -serviceShort "fridge" `
    -region2 $n.region -para $n.fr_para -issues $n.fr_issues -nearby $fr_nearby `
    -id_suffix "$($n.slug -replace '-','_')-fr" -dw_angle "no"
  Set-Content -Path "$dir/fridge-repair-$($n.slug).html" -Value $content -Encoding UTF8
  Write-Output "Created: fridge-repair-$($n.slug).html"
  $count++
}

Write-Output "Total pages created: $count"
