...
const SUBURBS = {
  'airdrie': {
    ...
    pricingIntro: `Airdrie pricing follows our standard rate structure: flat <strong>$89 diagnostic</strong>, waived when you proceed with the repair. Most just-out-of-warranty fixes here land in the $150&ndash;$320 range &mdash; quick post-warranty work that rarely justifies appliance replacement. Vintage parts sourcing for Old Town and Edgewater work occasionally carries a 3&ndash;5 day procurement window, always disclosed upfront.`,
  ...
  'okotoks': {
    ...
    pricingIntro: `Okotoks pricing follows our standard rate structure: flat <strong>$89 diagnostic</strong>, waived when you proceed with the repair. End-of-life mechanical work on 20-year-old units sometimes requires longer parts sourcing for vintage components &mdash; we always quote that timing upfront, never as a surprise add-on.`,
  ...
  'chestermere': {
    ...
    pricingIntro: `Chestermere pricing follows our standard rate structure: flat <strong>$89 diagnostic</strong>, waived when you proceed with the repair. Premium-brand work (Sub-Zero, Wolf, Miele, Thermador) follows the same pricing structure &mdash; we don\'t mark up labour for premium brands, only for genuinely longer or more complex jobs.`,
  ...
  'canmore': {
    ...
    pricingIntro: `Canmore pricing follows our standard rate structure: flat <strong>$89 diagnostic</strong>, waived when you proceed with the repair. Property-manager volume agreements available for multi-unit vacation rental operations &mdash; email calgary@appliancerepairneary.com for rate structures. Altitude-specific gas appliance work uses standard pricing &mdash; we don\'t surcharge for mountain expertise.`,
...
function buildMain(s, slug) {
  ...
  <div class="content-intro fade-in">
    ...
    <p style="font-size:1.0625rem;line-height:1.75;">Who repairs appliances in ${s.name}? <strong>Appliance Repair Near You &mdash; Calgary</strong> serves ${s.name} (population ${s.population}, postal codes ${s.postal}) and the broader ${s.cmaRole}. Book online or email <a href="mailto:calgary@appliancerepairneary.com">calgary@appliancerepairneary.com</a>. From <strong>$89 diagnostic</strong>, Mon&ndash;Sat 8AM&ndash;8PM, Sun 10AM&ndash;6PM Mountain Time. <strong>90-day parts &amp; labour warranty</strong> on every repair.</p>
...
function processSuburb(slug) {
  ...
  html = html.replace(/\$89 diagnostic/g, '$89 diagnostic');
